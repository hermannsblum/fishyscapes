...
@ex.command
def anomaly_segmentation_hj(testing_dataset, _run, _log, validation=False):
    # added import inside the function to prevent conflicts if this method is not being tested

    from submit.test import get_anomaly_detector
    from submit.config.config import config
    import numpy as np
    import torch
